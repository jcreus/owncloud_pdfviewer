...
var PDFView = {
  ...
  parseScale: function pdfViewParseScale(value, resetAutoSettings) {
    ...
    var pageWidthScale = (document.getElementById("viewer").contentWidth - kScrollbarPadding) /
                          currentPage.width / kCssUnits;
    var pageHeightScale = (document.getElementById("viewer").contentHeight - kScrollbarPadding) /
...
function webViewerLoad(url) {
  ...
  console.log("obrint");
  PDFView.open(url, parseFloat(scale));
